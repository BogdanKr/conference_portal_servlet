...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    /conference/admin"><fmt:message key="title"/></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}
                    /conference/admin/edit?id=${sessionScope.user.id}"><fmt:message key="edit_profile"/></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}
                    /conference/admin/userlist"><fmt:message key="user_list"/> </a>
            </li>
        </ul>
